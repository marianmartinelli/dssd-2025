...
from . import routes_projects, routes_auth, routes_organizations, routes_metrics
...
api_router.include_router(routes_organizations.router, prefix="/organizations", tags=["organizations"])
